...
st.subheader("By Sudarshan Pardeshi")
...
model = load_model(r"/workspaces/Deployment-of-Binary-Classification-with-keras/BookingStatusModel.keras")
pipeline = joblib.load(r"/workspaces/Deployment-of-Binary-Classification-with-keras/preprocessor.joblib")
